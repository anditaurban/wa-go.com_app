            ...
            <td class="flex justify-end whitespace-nowrap px-6 py-4 text-center text-sm font-medium sm:table-cell">
                <div class="dropdown d-inline">
                      ...
                      <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 28px, 0px); top: 0px; left: 0px; will-change: transform;">
                        <a onclick="handleDelete(${item.cd_id}, '${detail_id}')"
                            class="dropdown-item has-icon deleteButton" data-id="${item.cd_id} href="#">
...
function addFormListeners() {
  ...
  if (csSearch && csInput) {
      csSearch.addEventListener('input', (e) => {
          const option = Array.from(document.getElementById('cs_options').options)
